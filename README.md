...
Please see the [Installation (REMOVED FOR ANONYMITY)]() documentation for more details.
...
Fill out this [form (REMOVED FOR ANONYMITY)]() to download the Human2Sim2Robot assets, data, and pretrained models. After filling out this form, you will receive a URL `<download_url>`, which will be used next.
...
The goal of this section is to deploy the policy in the real world. The details for this section can be found in the [Hardware Deployment (REMOVED FOR ANONYMITY)]() documentation. For this step, you need to have a policy in `$PRETRAINED_POLICY_DIR` similar to above.
...
If you have any questions, issues, or feedback, please contact ANONYMOUS.
